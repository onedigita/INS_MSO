...
if(isNil "BRS_cam")then{BRS_cam="camera" camCreate[0,0,0];};
waitUntil{alive player};
disableSerialization;
if(count BRS_spawnPoints==0)then{hint "No BRS spawn points available";}else{
...
//PREPARE DIALOG
if(ctrlVisible 42500 and BRS_mapClose)then{null=[true]execVM "common\client\BRS\BRS_map\map_close.sqf";};

//RESET NV BUTTON
if(ctrlVisible 30051 and !BRS_nvgON)then{(_display displayCtrl 30052)ctrlShow false;};
...
exitBRS=false;	
while{!exitBRS}do{sleep 0.5;0=[]call BRS_RP;};};