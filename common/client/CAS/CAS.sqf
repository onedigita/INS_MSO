...
_dir=random 360;
_dis=8000;
_ranPos=[(_loc select 0)+_dis*sin _dir,(_loc select 1)+_dis*cos _dir,700];//350
...
(driver _buzz)doMove[_loc select 0,_loc select 1,700];//350
...
deleteVehicle vehicle _pilot;deleteVehicle _buzz;deleteGroup _grp;
sleep 600;
casRequest=false;
//_num=_num+1;
