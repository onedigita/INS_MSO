...
_missionRoot+"common\client\vip_lit\resource\drop1.paa",
_missionRoot+"common\client\vip_lit\resource\drop2.paa",
_missionRoot+"common\client\vip_lit\resource\drop3.paa",
_missionRoot+"common\client\vip_lit\resource\drop4.paa",
_missionRoot+"common\client\vip_lit\resource\drop5.paa",
_missionRoot+"common\client\vip_lit\resource\drop6.paa",
_missionRoot+"common\client\vip_lit\resource\drop7.paa"];
...
vip_lit_var_cl_mapFlashlightTex=_missionRoot+"common\client\vip_lit\resource\flashlight.paa";

//set flashlight keybind (or grab from profile)
if(count(profileNamespace getVariable["vip_lit_var_cl_mapFlashlightKey",[]])>0)then{
vip_lit_var_cl_mapFlashlightKey=profileNamespace getVariable "vip_lit_var_cl_mapFlashlightKey";}else{
vip_lit_var_cl_mapFlashlightKey=[33,false,false,false]};
...
_viewPortRatioFixY=_realViewPortX/(_realViewPortY/_viewPortY*_viewPortX)}else{
