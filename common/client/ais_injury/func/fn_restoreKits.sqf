...
To prevent duplicates, this function uses some sort of Mutex/Semaphore on the unit
*/
...
_numMedi=_items select 3;
	for "_i" from 1 to _numFakUniform do{_unit addItemToUniform "FirstAidKit";};
	for "_i" from 1 to _numFakVest do{_unit addItemToVest "FirstAidKit";};
	for "_i" from 1 to _numFakBackpack do{_unit addItemTobackpack "FirstAidKit";};
	for "_i" from 1 to _numMedi do{_unit addItem "Medikit";};
};
