...
w=0.01289*safezoneW;
h=0.0980*safezoneH;
action="closeDialog 0;_nil=[]ExecVM ""common\client\Strobe\StrobeON.sqf""";};

class RscPicture_1200: RscPictureStrobe{
idc=-1;
text="common\client\Strobe\StrobeOFF.paa";
x=0.304062*safezoneW+safezoneX;
...
w=0.01289*safezoneW;
h=0.0980*safezoneH;
action="closeDialog 0;_nil=[]ExecVM ""common\client\Strobe\StrobeOFF.sqf""";};

class RscPicture_1200: RscPictureStrobe{
idc=-1;
text="common\client\Strobe\StrobeON.paa";
x=0.304062*safezoneW+safezoneX;
y=0.5*safezoneH+safezoneY;
w=0.0721875*safezoneW;
h=0.253*safezoneH;};
