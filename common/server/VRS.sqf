...
sleep 1;
	...
	if(_veh isKindOf "B_UAV_02_CAS_F")then{_veh enableUAVConnectability[_veh,true];_veh enableUAVWaypoints true;};
	if(_veh isKindOf "CUP_B_USMC_MQ9")then{_veh enableUAVConnectability[_veh,true];_veh enableUAVWaypoints true;};
