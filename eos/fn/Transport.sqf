private["_pad","_getToMkr","_cargoGrp","_vehicle"];
_mkr=(_this select 0);
_veh=(_this select 1);
...
_pos=[_mkr,false]call SHKpos;
_pad=createVehicle["Land_HelipadEmpty_F",_pos,[],0,"NONE"];
if(_dbug)then{0=[_mkr,_counter,"Unload Pad",(getPos _pad)]call EOSdbug;};

{_x allowFleeing 0}forEach units _grp;{_x allowFleeing 0}forEach units _cargoGrp;
