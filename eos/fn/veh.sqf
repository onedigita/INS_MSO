...
_vehicleType=[_faction,_type]call EOSgetUnitPool;
...
clearItemCargoGlobal _vehicle;clearBackpackCargoGlobal _vehicle;_vehicle disableTIEquipment true;_vehicle disableNVGEquipment true;_vehicle lock 3;_vehicle setCollisionLight false;_vehicle setPilotLight true;_vehicle allowCrewInImmobile true;
...
_unit assignAsDriver _vehicle;_unit moveInDriver _vehicle;_unit setVariable["NOAI",1,false];
_vehCrew set[count _vehCrew,_unit];
_unit enableSimulationGlobal false;_unit hideObjectGlobal true;_unit disableAI "ALL";_unit setBehaviour "CARELESS";_unit allowDamage false;_unit enableMimics false;_unit setSpeaker "NoVoice";_unit disableConversation true;_unit enableMimics false;};
if(_currentPosition select 0=="turret")then{
_unit=_grp createUnit[(_vehicleType select 1),_position,[],0,"CAN_COLLIDE"];
_unit assignAsGunner _vehicle;_unit moveInTurret[_vehicle,_currentPosition select 1];
_vehCrew set[count _vehCrew,_unit];
_unit enableSimulationGlobal false;_unit hideObjectGlobal true;_unit disableAI "ALL";_unit setBehaviour "CARELESS";_unit allowDamage false;_unit enableMimics false;_unit setSpeaker "NoVoice";_unit disableConversation true;_unit enableMimics false;};
